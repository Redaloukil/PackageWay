...
class NotRecovered extends React.Component {
  componentWillMount() {
    this.props.onLoad(agent.Packages.perUserNotRecovered());
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(NotRecovered);
